...
-- Members indexes
DROP INDEX idx_members_expiry ON members;
CREATE INDEX idx_members_expiry ON members(expiry_date);

DROP INDEX idx_members_join_date ON members;
